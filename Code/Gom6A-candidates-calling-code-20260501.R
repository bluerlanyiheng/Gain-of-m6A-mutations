...
#When a given HGVSG mutation has multiple functional annotations, missense mutations were prioritized for annotation, followed by UTR mutations, while synonymous mutations were assigned the lowest priority and were only annotated as such if not concurrently annotated as any non-synonymous variant..
